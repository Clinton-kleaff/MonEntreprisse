...
export default function Register() {
  ...
  return (
    <>
      <Helmet>
        <title>Inscription | MonEntreprise</title>
      </Helmet>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full p-3 border ${errors.confirmPassword ? "border-red-500" : "border-gray-200"} rounded-xl focus:border-[#d81b60] focus:ring-2 focus:ring-[#d81b60]/20 outline-none transition pr-10`}
                  placeholder="••••••••"
                />
                <button
                  type="button"
