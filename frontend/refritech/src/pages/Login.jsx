...
export default function Login() {
  ...
  // Handle Google OAuth redirect (token and user in URL)
  useEffect(() => {
  ...
  return (
    <>
      <Helmet>
        <title>Connexion | WaGradeTech</title>
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center pt-4 pb-12 px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-sm text-[#d81b60] hover:underline font-medium">
                Mot de passe oublié ?
              </Link>
            </div>
